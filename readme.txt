...
Contributors:      Mr2P
Donate link:       https://queryloopblock.com?utm_source=wp.org&utm_campaign=readme&utm_medium=link&utm_content=QLE+Donate
Tags:              query, query loop, block, filter, sorting
Requires PHP:      8.0
...
Make everyone love the Query Loop block
...
To make you love the Query Loop block
